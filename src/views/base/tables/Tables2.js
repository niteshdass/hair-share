...
const Tables2 = () => {
  ...
  function getNewOrder (){
    ...
    db.collection("allOrderList").where('product_order.status', '==',"refunded").orderBy("product_order.booking_date", "desc").onSnapshot(function(querySnapshot){
      setNewOrder1(
    ...
    db.collection("allOrderList").where('product_order.status', '==',"cancelled").orderBy("product_order.booking_date", "desc").onSnapshot(function(querySnapshot){
