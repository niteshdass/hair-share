...
toast.configure()
function ComonTable1({buyer,email,phone,booking_date,booking_time,total_fees,status,id,product_order_details}) {
...
const handleShow2 = () =>{
  ...
  setShow2(true);
      ...
      function acceptedOrder(){
            ...
            setShow2(false)
            toast.success("The order successfully complete !", {
          ...
          <Button variant="secondary" onClick={handleClose}>
            Close
                  ...
                  <td className="text-center">
                    ...
                    <a className="btn btn-danger" style={{margin:"1px" , color:"white"}}  onClick={handleShow1} >
             
         Cancel
           </a>


           <a className="btn btn-primary" style={{margin:"1px" , color:"white"}}  onClick={handleShow2}>Complete</a>
         </CCol>
                    </td>
                    ...
                    <a block className="btn btn-warning" onClick={handleShow}>Details</a>
         </CCol>
                    </td>
